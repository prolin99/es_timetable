...
.weekd{
 ...
 <h3><{$data.n_y}> 學年度<{$data.n_s}> 學期</h3>
      ...
      <div class="col-xs-10" id="table_div">

      	<div class="row" >

      	<div class='col-md-5'>
          <form action="teacher_list.php"  method="GET">
            <div class="form-group">
                <{if ($data.isteacher)}>
              <label for="teacher_id" class="col-md-4 control-label">查詢教師:</label>
              <div class='col-md-8'>
      ...
      <div class='col-md-5'>
          <form action="teacher_list.php"  method="GET">
              <div class="form-group">
                <label for="room_id" class="col-md-4 control-label">查詢教室:</label>
                <div class='col-md-8'>
      ...
      <tr>
      <td class="col-xs-1  col-xs-1"><{$DEF_SET.sects_cht_list[$smarty.section.si.index]}><br />
